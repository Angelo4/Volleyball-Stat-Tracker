...
import { FB } from '@greatsumini/react-facebook-login/dist/types/fb.type';
...
export declare type DialogParams = {
    /** same as appId */
    client_id: string;
...
export declare type FacebookLoginProps = Pick<InitParams, 'appId'> & {
    /** @default 'en_US' */
    language?: string;
    /** Comma seperated list of permissions to request during login.
     *
