...
/* harmony import */ var victory_vendor_d3_shape__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! victory-vendor/d3-shape */ "../../victory-vendor/node_modules/d3-shape/src/curve/linear.js");
/* harmony import */ var victory_vendor_d3_shape__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! victory-vendor/d3-shape */ "../../victory-vendor/node_modules/d3-shape/src/lineRadial.js");
/* harmony import */ var victory_vendor_d3_shape__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! victory-vendor/d3-shape */ "../../victory-vendor/node_modules/d3-shape/src/line.js");
...
var getInterpolationFunction = function (props) {
  ...
  return victory_vendor_d3_shape__WEBPACK_IMPORTED_MODULE_1__["default"];
};
var getLineFunction = function (props) {
  var polar = props.polar,
      scale = props.scale,
      horizontal = props.horizontal;
  return polar ? victory_vendor_d3_shape__WEBPACK_IMPORTED_MODULE_2__["default"]().defined(defined).curve(getInterpolationFunction(props)).angle(getAngleAccessor(scale)).radius(getYAccessor(scale)) : victory_vendor_d3_shape__WEBPACK_IMPORTED_MODULE_3__["default"]().defined(defined).curve(getInterpolationFunction(props)).x(horizontal ? getYAccessor(scale) : getXAccessor(scale)).y(horizontal ? getXAccessor(scale) : getYAccessor(scale));
};
...
function getScaleFromName(name) {
  if (validScale(name)) {
    ...
    return victory_vendor_d3_scale__WEBPACK_IMPORTED_MODULE_5__[methodName]();
  }
