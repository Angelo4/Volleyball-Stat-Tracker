...
import type { Meta, ReactFramework } from '@storybook/react/dist/ts3.9/client/preview/types-6-0';
...
export declare function composeStory<TArgs = Args>(story: ComposedStory<ReactFramework, TArgs>, componentAnnotations: Meta<TArgs | any>, projectAnnotations?: ProjectAnnotations<ReactFramework>, exportsName?: string): {
    (extraArgs: Partial<TArgs>): import("@storybook/react/dist/ts3.9/client/preview/types").StoryFnReactReturnType;
    storyName: string;
    args: Args;
