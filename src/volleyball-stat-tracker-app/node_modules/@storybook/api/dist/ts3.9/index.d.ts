...
import Store, { Options } from '@storybook/api/dist/ts3.9/store';
import type { StoriesHash, Story, Root, Group } from '@storybook/api/dist/ts3.9/lib/stories';
import type { ComposedRef, Refs } from '@storybook/api/dist/ts3.9/modules/refs';
import { isGroup, isRoot, isStory } from '@storybook/api/dist/ts3.9/lib/stories';
import * as provider from '@storybook/api/dist/ts3.9/modules/provider';
import * as addons from '@storybook/api/dist/ts3.9/modules/addons';
import * as channel from '@storybook/api/dist/ts3.9/modules/channel';
import * as notifications from '@storybook/api/dist/ts3.9/modules/notifications';
import * as settings from '@storybook/api/dist/ts3.9/modules/settings';
import * as releaseNotes from '@storybook/api/dist/ts3.9/modules/release-notes';
import * as stories from '@storybook/api/dist/ts3.9/modules/stories';
import * as refs from '@storybook/api/dist/ts3.9/modules/refs';
import * as layout from '@storybook/api/dist/ts3.9/modules/layout';
import * as shortcuts from '@storybook/api/dist/ts3.9/modules/shortcuts';
import * as url from '@storybook/api/dist/ts3.9/modules/url';
import * as version from '@storybook/api/dist/ts3.9/modules/versions';
import * as globals from '@storybook/api/dist/ts3.9/modules/globals';
declare const ActiveTabs: {
    SIDEBAR: "sidebar";
    CANVAS: "canvas";
    ADDONS: "addons";
};
export { default as merge } from '@storybook/api/dist/ts3.9/lib/merge';
