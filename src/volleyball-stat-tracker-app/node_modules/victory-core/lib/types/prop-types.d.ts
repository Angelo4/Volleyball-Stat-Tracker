...
import { AnimationEasing, AnimationStyle } from "victory-core/lib/victory-animation/victory-animation";
import { StringOrNumberOrCallback } from "victory-core/lib/types/callbacks";
...
export declare type ValueOrAccessor<ValueType = unknown, PropsType = object> = ValueType | ((props: PropsType) => ValueType);
...
export declare type DataGetterPropType = ValueOrAccessor<string | string[] | number | number[]>;
