...
import { VictoryCommonProps } from "victory-core/lib/victory-util";
import type { DomainPropType, ScaleXYPropType } from "victory-core/lib/types/prop-types";
...
export declare function getDomainCoordinates(props: Pick<VictoryCommonProps, "scale" | "horizontal">, domain?: DomainPropType): DomainPropType;
