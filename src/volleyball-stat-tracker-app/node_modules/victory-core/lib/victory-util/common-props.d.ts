...
import { OriginType } from "victory-core/lib/victory-label/victory-label";
import { PaddingProps, VictoryThemeDefinition } from "victory-core/lib/victory-theme/types";
import { AnimatePropTypeInterface, CategoryPropType, ColorScalePropType, D3Scale, DataGetterPropType, DomainPaddingPropType, DomainPropType, EventCallbackInterface, RangePropType, ScalePropType, SortOrderPropType, StringOrNumberOrList } from "victory-core/lib/types/prop-types";
import { NumberOrCallback, StringOrCallback } from "victory-core/lib/types/callbacks";
