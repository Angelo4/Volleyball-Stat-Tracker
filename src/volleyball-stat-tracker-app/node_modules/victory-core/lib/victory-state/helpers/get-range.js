...
function getRange(_ref, axis) {
  ...
  var rangeFromProps = (0, _typeHelpers.getValueForAxis)(range, axis);

  if ((0, _typeHelpers.isTuple)(rangeFromProps)) {
    return rangeFromProps;
  } // TODO: Convert this to TS


  var padding = (0, _helpers.getPadding)({
