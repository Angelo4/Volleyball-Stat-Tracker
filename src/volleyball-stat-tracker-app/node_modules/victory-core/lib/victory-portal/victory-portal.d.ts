...
import { PortalContext } from "victory-core/lib/victory-portal/portal-context";
...
export declare class VictoryPortal extends React.Component<VictoryPortalProps> {
    ...
    static contextType: React.Context<import("victory-core/lib/victory-portal/portal-context").PortalContextValue>;
